...
st.write(f"Linear regression was used to allow observation of long-term trends from air pollutant concentrations over time. This model shows a clear visual representation of the general increase and decrease in air pollutant levels in {city}.")
